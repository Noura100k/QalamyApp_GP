...
export default function Add_Word_Exam({navigation}) {
    return (
      <View style={styles_con.container}>
      <Text style={styles_con.title}>اكتب الكلمة</Text>
      <CustomInput placeholder="قلم، كتاب،...."/>
      <Text style={styles_con.title}>سجل الكلمة</Text>
      <Microphone/>
